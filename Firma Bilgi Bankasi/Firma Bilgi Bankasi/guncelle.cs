    ...
    public partial class guncelle : Form
    {
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            if(textBox1.Text!="")
            {
                ...
                if(kontrol==1)
                {
                    ...
                    // But how do we read something out of our table ?
                    // First lets build a SQL-Query again:
                    sqlite_cmd.CommandText = "SELECT * FROM adres where Firma_id=(Select id From firma where adi='" + textBox1.Text.ToString() + "')";
                    ...
                    // But how do we read something out of our table ?
                    // First lets build a SQL-Query again:
                    sqlite_cmd.CommandText = "SELECT * FROM telefon where Firma_id=(Select id From firma where adi='" + textBox1.Text.ToString() + "')";
                    ...
                    // But how do we read something out of our table ?
                    // First lets build a SQL-Query again:
                    sqlite_cmd.CommandText = "SELECT * FROM faks where Firma_id=(Select id From firma where adi='" + textBox1.Text.ToString() + "')";
                    ...
                    // But how do we read something out of our table ?
                    // First lets build a SQL-Query again:
                    sqlite_cmd.CommandText = "SELECT * FROM web where Firma_id=(Select id From firma where adi='" + textBox1.Text.ToString() + "')";
                    ...
                    // But how do we read something out of our table ?
                    // First lets build a SQL-Query again:
                    sqlite_cmd.CommandText = "SELECT * FROM email where Firma_id=(Select id From firma where adi='" + textBox1.Text.ToString() + "')";
                    ...
                    // But how do we read something out of our table ?
                    // First lets build a SQL-Query again:
                    sqlite_cmd.CommandText = "Select * From sektor Where id In(SELECT Sektor_id FROM Firma_has_Sektor where Firma_id=(Select id From firma where adi='" + textBox1.Text.ToString() + "'))";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            if (textBox6.Text != "" && listBox8.Items.Count > 0)
            {
                ...
                while (sqlite_datareader.Read()) // Read() returns true if there is still a result line to read
                {
                    if(sqlite_datareader["adi"].ToString()==textBox6.Text && textBox6.Text!=textBox1.Text)
                    {
                        kontrol=1;
                        break;
                    }
                ...
                if(kontrol==0)
                {
                    ...
                    sqlite_cmd.CommandText = "Update firma Set adi='" + textBox6.Text.ToString() + "' Where adi='" + textBox1.Text.ToString() + "'";
